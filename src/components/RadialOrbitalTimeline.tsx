            ...
            return (
              ...
              >
                <div
                  ...
                  style={{
                    background: `radial-gradient(circle, rgba(255,84,31,0.2) 0%, rgba(255,84,31,0) 70%)`,
                ...
                {isExpanded && (
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-black/90 backdrop-blur-lg border-primary/30 shadow-xl shadow-primary/10 overflow-visible">
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 pt-3 border-t border-white/10">
                        ...
                        <div className="w-full h-1 bg-white/10 rounded-full overflow-hidden">
                          <div
                            className="h-full bg-gradient-to-r from-primary via-orange-300 to-primary"
